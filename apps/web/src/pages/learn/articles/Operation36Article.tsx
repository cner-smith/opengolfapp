...
function ProgressionLadder() {
  return (
    <div style={{ maxWidth: 460, margin: '4px auto 22px' }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <div
        style={{
          ...
          width: '100%',
          maxWidth: 360,
          border: `1px solid ${goal ? '#1F3D2C' : '#D9D2BF'}`,
          background: goal ? '#1F3D2C' : '#EBE5D6',
          borderRadius: 2,
          padding: '10px 16px',
        }}
      >
        ...
        {caption && (
          <span
            style={{
              fontSize: 12,
              color: goal ? 'rgba(242,238,229,0.78)' : '#8A8B7E',
            }}
          >
            {caption}
          </span>
...
function Gate() {
  return (
    ...
    >
      <div style={{ width: 2, height: 8, background: '#9F9580' }} />
      <span
  ...
  return (
    <section style={{ borderTop: '1px solid #D9D2BF', paddingTop: 18, marginTop: 22 }}>
      ...
      <div style={{ display: 'grid', gap: 14, maxWidth: 640 }}>
        <div>
          <SrcLabel>The program — distance progression and the "shoot 36" rule</SrcLabel>
          <SrcBody>
            <Src href="https://operation36.golf/how-it-works/">
            ...
            <Src href="https://www.pga.com/story/operation-36-helping-golfers-find-a-love-for-the-game-for-life">
              PGA of America
            </Src>{' '}
            on the program's founding (2010, Matthew Reagan and Ryan Dailey) and
            why achievable milestones keep beginners connected to the game.
          </SrcBody>
        </div>
        <div>
          <SrcLabel>Why achievable challenges build skill and confidence</SrcLabel>
          <SrcBody>
            <Src href="https://collegeofgolf.keiseruniversity.edu/developing-confidence-in-beginner-golfers-thoughts-and-recommendations/">
              Keiser University College of Golf · Developing Confidence in
              Beginner Golfers
            </Src>{' '}
            — on the optimal challenge point: learning is fastest when a task is
            neither too easy nor too hard, so difficulty should rise step by step
            as competence does.
          </SrcBody>
        </div>
      </div>
