    ...
    >
      ...
      {!adding ? (
        ...
        <TeeRowEditor
          ...
          onSave={async (patch) => {
            // upsert.error already surfaces failures reactively above; the
            // try/catch here is just to stop the rejection from becoming an
            // unhandled promise warning (onSave is invoked from onClick).
            try {
